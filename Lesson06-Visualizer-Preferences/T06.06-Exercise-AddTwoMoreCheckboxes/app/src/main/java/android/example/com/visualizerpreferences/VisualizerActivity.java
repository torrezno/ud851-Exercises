...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            Boolean defaultValue = getResources().getBoolean(R.bool.pref_show_mid_default);
            Boolean pref = sharedPreferences.getBoolean(key,defaultValue);
            mVisualizerView.setShowMid(pref);
        }else if (key.equals(getString(R.string.pref_show_treble_key))) {
            Boolean defaultValue = getResources().getBoolean(R.bool.pref_show_treble_default);
            Boolean pref = sharedPreferences.getBoolean(key,defaultValue);
            mVisualizerView.setShowTreble(pref);
        }
    }
