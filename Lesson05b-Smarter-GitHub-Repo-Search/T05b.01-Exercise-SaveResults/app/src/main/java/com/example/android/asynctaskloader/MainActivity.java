...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_RAW_JSON_RESPONSE = "RAW_JSON_RESPONSE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            ...
            if(savedInstanceState.containsKey(KEY_RAW_JSON_RESPONSE)){
                mSearchResultsTextView.setText(savedInstanceState.getString(KEY_RAW_JSON_RESPONSE));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(KEY_RAW_JSON_RESPONSE,rawJson);
    }
